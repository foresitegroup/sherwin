...
function require_priv($action) {
    global $CONFIG_EXT, $database, $my, $lang_system, $lang_general, $acl;
...
function has_priv($action) {
    global $CONFIG_EXT, $database, $my, $lang_system, $lang_generalm, $acl;
...
/* Display category form */
	global $CONFIG_EXT, $database, $template_cat_form, $THEME_DIR, $errors, $lang_cat_admin_data, $lang_general, $acl;
	// build category list
...
function extcal_get_local_time ($target_timezone = '') {
	...
	//$zonedate = mktime(gmdate('G'), gmdate('i'), gmdate('s'), gmdate('n'), gmdate('j'), gmdate('Y'), 0) + ($target_timezone * 3600);
	$zonedate = mktime(gmdate('G'), gmdate('i'), gmdate('s'), gmdate('n'), gmdate('j'), gmdate('Y'));
...
/* Process message data with various conversions */
	...
	global $CONFIG_EXT, $database, $CFG, $_MAMBOTS, $params;
