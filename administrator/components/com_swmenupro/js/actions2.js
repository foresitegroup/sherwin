 ...
 //   href.value = href.value.trim();
  ...
  //  node.href = href.value;
    ...
    // node.target = target.value;
	  document.getElementById(node.id+'-image').value=image.value;
	  document.getElementById(node.id+'-image_over').value=image_over.value;
	  document.getElementById(node.id+'_hspace').value=image_hspace.value;
	  document.getElementById(node.id+'_vspace').value=image_vspace.value;
	  document.getElementById(node.id+'_width').value=image_width.value;
	  document.getElementById(node.id+'_height').value=image_height.value;
	  document.getElementById(node.id+'_over_width').value=image_over_width.value;
	  document.getElementById(node.id+'_over_height').value=image_over_height.value;
	  document.getElementById(node.id+'_over_hspace').value=image_over_hspace.value;
	  document.getElementById(node.id+'_over_vspace').value=image_over_vspace.value;
	  document.getElementById(node.id+'_showname').value=showname.value;
	  document.getElementById(node.id+'_image_align').value=image_align.value;
	   document.getElementById(node.id+'_normal_css').value=normal_css.value;
	  document.getElementById(node.id+'_over_css').value=over_css.value;
	   document.getElementById(node.id+'_showitem').value=showitem.value;
	  document.getElementById(node.id+'_target').value=target.value;
       // tree.updateHtml();
    }
}
