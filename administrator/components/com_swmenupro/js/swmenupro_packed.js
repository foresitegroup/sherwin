...
function applyattrib(temp_attrib,i){
	...
	var node = tree.allNodes['tree-'+(i+1)];
				...
				if(temp_attrib=='image1'||temp_attrib=='image2'){
					...
					document.getElementById('tree-'+(i+1)+'-image').value = temp_globalimage;
					document.getElementById('tree-'+(i+1)+'_width').value = temp_globalimage_width;
					document.getElementById('tree-'+(i+1)+'_height').value = temp_globalimage_height;
					document.getElementById('tree-'+(i+1)+'_hspace').value = temp_globalimage_hspace;
					document.getElementById('tree-'+(i+1)+'_vspace').value = temp_globalimage_vspace;
					}else{
					...
					document.getElementById('tree-'+(i+1)+'-image_over').value = temp_globalimage;
					document.getElementById('tree-'+(i+1)+'_over_width').value = temp_globalimage_width;
					document.getElementById('tree-'+(i+1)+'_over_height').value = temp_globalimage_height;
					document.getElementById('tree-'+(i+1)+'_over_hspace').value = temp_globalimage_hspace;
					document.getElementById('tree-'+(i+1)+'_over_vspace').value = temp_globalimage_vspace;
					}
				
				
				}else if (temp_attrib=='showname'){
				node.showname=1;
				document.getElementById('tree-'+(i+1)+'_showname').value = 1;
				}else if (temp_attrib=='dontshowname'){
				node.showname=0;
				document.getElementById('tree-'+(i+1)+'_showname').value = 0;
				}else if (temp_attrib=='imageleft'){
				node.image_align="left";
				document.getElementById('tree-'+(i+1)+'_image_align').value = "left";
				}else if (temp_attrib=='imageright'){
				node.image_align="right";
				document.getElementById('tree-'+(i+1)+'_image_align').value = "right";
				}else if (temp_attrib=='islink'){
				document.getElementById('tree-'+(i+1)+'_target').value = 1;
				}else if (temp_attrib=='isnotlink'){
				document.getElementById('tree-'+(i+1)+'_target').value = 0;
				}else if (temp_attrib=='showitem'){
				document.getElementById('tree-'+(i+1)+'_showitem').value = 1;
				}else if (temp_attrib=='dontshowitem'){
				document.getElementById('tree-'+(i+1)+'_showitem').value = 0;
				}else if (temp_attrib=='normalcss'){
				document.getElementById('tree-'+(i+1)+'_normal_css').value = document.getElementById('auto_css').value;
				}else if (temp_attrib=='overcss'){
				document.getElementById('tree-'+(i+1)+'_over_css').value = document.getElementById('auto_css').value;
				}
