...
<table cellspacing="0" cellpadding="0" width="400">
    <tr>
        <td valign="top">
            <div class="DynamicTree" style="height:250px;">
...
<div id="css_buttons" align="center">
  ...
  <?php 
  $count=1;
  foreach($rows as $ordered){

  	if($ordered['SHOWNAME']==null || $ordered['SHOWNAME']==1){
  		$showname=1;
  	}else{
  		$showname=0;
  	}
  	if($ordered['SHOWITEM']==null || $ordered['SHOWITEM']==1){
  		$showitem=1;
  	}else{
  		$showitem=0;
  	}
  	if($ordered['TARGETLEVEL']==null || $ordered['TARGETLEVEL']==1){
  		$target=1;
  	}else{
  		$target=0;
  	}
  	...
  	$image1src= @$image1[0] ? "../".$image1[0] : "";
  	$image1vspace= @$image1[4] ? $image1[4] : "";
  	$image1hspace= @$image1[3] ? $image1[3] : "";
  	$image2src= @$image2[0] ?  "../".$image2[0] : "";
  	$image2vspace= @$image2[4] ? $image2[4] : "";
  	$image2hspace= @$image2[3] ? $image2[3] : "";
  	$image1width=@$image1[1] ?  $image1[1] : "";
  	$image1height= @$image1[2] ? $image1[2] : "";
  	$image2width= @$image2[1] ? $image2[1] : "";
  	$image2height= @$image2[2] ? $image2[2] : "";

  	echo "<input type=\"hidden\" value=\"".$ordered['ID']."\" id=\"tree-".$count."-id\" name=\"tree-".$count."-id\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image1src."\" id=\"tree-".$count."-image\" name=\"tree-".$count."-image\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image2src."\" id=\"tree-".$count."-image_over\" name=\"tree-".$count."-image_over\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image1width."\" id=\"tree-".$count."_width\" name=\"tree-".$count."_width\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image1height."\" id=\"tree-".$count."_height\" name=\"tree-".$count."_height\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image1hspace."\" id=\"tree-".$count."_hspace\" name=\"tree-".$count."_hspace\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image1vspace."\" id=\"tree-".$count."_vspace\" name=\"tree-".$count."_vspace\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image2width."\" id=\"tree-".$count."_over_width\" name=\"tree-".$count."_over_width\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image2height."\" id=\"tree-".$count."_over_height\" name=\"tree-".$count."_over_height\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image2hspace."\" id=\"tree-".$count."_over_hspace\" name=\"tree-".$count."_over_hspace\" />\n";
  	echo "<input type=\"hidden\" value=\"".$image2vspace."\" id=\"tree-".$count."_over_vspace\" name=\"tree-".$count."_over_vspace\" />\n";
  	echo "<input type=\"hidden\" value=\"".$showname."\" id=\"tree-".$count."_showname\" name=\"tree-".$count."_showname\" />\n";
  	echo "<input type=\"hidden\" value=\"".$ordered['IMAGEALIGN']."\" id=\"tree-".$count."_image_align\" name=\"tree-".$count."_image_align\" />\n";
  	echo "<input type=\"hidden\" value=\"".$ordered['NCSS']."\" id=\"tree-".$count."_normal_css\" name=\"tree-".$count."_normal_css\" />\n";
  	echo "<input type=\"hidden\" value=\"".$ordered['OCSS']."\" id=\"tree-".$count."_over_css\" name=\"tree-".$count."_over_css\" />\n";
  	echo "<input type=\"hidden\" value=\"".$target."\" id=\"tree-".$count."_target\" name=\"tree-".$count."_target\" />\n";
  	echo "<input type=\"hidden\" value=\"".$showitem."\" id=\"tree-".$count."_showitem\" name=\"tree-".$count."_showitem\" />\n";
