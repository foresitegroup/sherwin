...
define( '_SW_LANGUAGE_FAIL', 'A nyelvi fájl feltöltése nem sikerült, gyõzõdjön meg arról, hogy írhatóak-e az alábbi listában szereplõ mappák' );
...
define( '_SW_COPY_STYLE_TIP', 'Válasszon ki egy, már meglévõ menümodult, hogy annak stílusbeállításait hozzáadja egy új menümodulhoz' );
define( '_SW_EDIT_CSS_TIP', 'A(z) %s menümodulhoz tartozó külsõ stíluslap szerkesztéséhez kattintson ide ' );
define( '_SW_EXPORT_MODULE_TIP', 'A(z) %s menümodulhoz tartozó, jelenleg használt stílusbeállítások külsõ stíluslapba történõ kimentéséhez, kattintson ide' );
...
define( '_SW_PREVIEW_MODULE_TIP', 'A(z) %s menümodul elõbukkanó ablakban megjelenõ, elõnézeti képének megtekintéséhez kattintson ide' );
...
//Program Notices
define( '_SW_NO_MODULE_NOTICE', 'A megfelelõ mûködéshez az SWmenuPro modult is telepítse.' );
define( '_SW_NO_MENU_NOTICE', 'Válasszon menürendszert az alábbi lenyíló listából.' );
define( '_SW_DELETE_MODULE_NOTICE', 'Biztos benne, hogy törölni akarja a következõt: ' );
...
define( '_SW_MENU_CHANGE_NOTICE', 'Megváltoztatta a menümodulhoz tartozó menüforrást. Ez az oldal nem jeleníthetõ meg, amíg nem érvényesíti a változtatásokat, vagy nem állítja vissza az eredeti menüforrást.' );
...
define( '_SW_NO_SAVE_MENU_CSS_MESSAGE', 'A külsõ CSS fájlt nem sikerült létrehozni. Gyõzõdjön meg arról, hogy írható-e a modules/mod_swmenupro/styles mappa.' );
...
//tool tips
define( '_SW_MENU_SOURCE_TIP', 'Válassza ki azt az érvényes/létezõ menüt, amely forrásként szolgál a menümodul számára.' );
define( '_SW_PARENT_TIP', 'Válassza ki azt a szülõ elemet, amely megjeleníti a forrásmenü egy részét. Ha mindegyik menüpontot meg akarja jeleníteni, akkor a szülõ elemet állítsa TOP-ra .' );
