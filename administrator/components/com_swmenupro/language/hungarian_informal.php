...
define( '_SW_LANGUAGE_FAIL', 'A nyelvi fájl feltöltése nem sikerült, gyõzõdj meg arról, hogy írhatóak-e az alábbi listában szereplõ mappák' );
...
//Page Names
define( '_SW_MENU_MODULE_MANAGER', 'Menümodul kezelõ' );
define( '_SW_MANUAL_CSS_EDITOR', 'Kézi CSS szerkesztõ' );
define( '_SW_INDIVIDUAL_ITEM_EDITOR', 'Egyedi menüpont szerkesztõ' );
...
define( '_SW_COPY_MODULE', 'Meglévõ menüstílus használata' );
...
define( '_SW_COPY_STYLE_TIP', 'Válassz ki egy, már meglévõ menümodult, hogy annak stílusbeállításait hozzáadd egy új menümodulhoz' );
define( '_SW_EDIT_CSS_TIP', 'A(z) %s menümodulhoz tartozó külsõ stíluslap szerkesztéséhez kattints ide ' );
define( '_SW_EXPORT_MODULE_TIP', 'A(z) %s menümodulhoz tartozó, jelenleg használt stílusbeállítások külsõ stíluslapba történõ kimentéséhez, kattints ide' );
...
define( '_SW_PREVIEW_MODULE_TIP', 'A(z) %s menümodul elõbukkanó ablakban megjelenõ, elõnézeti képének megtekintéséhez kattints ide' );
...
define( '_SW_CANCEL_TIP', 'A változtatások érvénytelenítéséhez és a menükezelõbe való visszatéréshez kattints ide' );
define( '_SW_PREVIEW_TIP', 'Az elõbukkanó ablakban megjelenõ elõnézeti kép megtekintéséhez kattints ide' );
define( '_SW_EXPORT_TIP', 'A jelenleg használt stílusbeállítások külsõ stíluslapba történõ kimentéséhez kattints ide' );
...
define( '_SW_RETURN_MANAGER_LINK', 'Visszatérés az swMenuPro menümodul kezelõjéhez' );


//Program Notices
define( '_SW_NO_MODULE_NOTICE', 'A megfelelõ mûködéshez az SWmenuPro modult is telepítened kell.' );
define( '_SW_NO_MENU_NOTICE', 'Válassz menürendszert az alábbi lenyíló listából.' );
define( '_SW_DELETE_MODULE_NOTICE', 'Biztos vagy benne, hogy törölni akarod a következõt: ' );
...
define( '_SW_MENU_CHANGE_NOTICE', 'Megváltoztattad a menümodulhoz tartozó menüforrást. Ez az oldal nem jeleníthetõ meg, amíg nem érvényesíted a változtatásokat, vagy nem állítod vissza az eredeti menüforrást.' );


//Program Messages
define( '_SW_DELETE_MODULE_MESSAGE', 'A menümodul törlése sikerült' );
define( '_SW_SAVE_MENU_MESSAGE', 'A beállítások mentése sikerült' );
define( '_SW_SAVE_MENU_CSS_MESSAGE', 'A beállítások mentése és a külsõ CSS fájl létrehozása sikerült' );
define( '_SW_SAVE_CSS_MESSAGE', 'A külsõ CSS fájl mentése sikerült' );
define( '_SW_NO_SAVE_MENU_CSS_MESSAGE', 'A külsõ CSS fájlt nem sikerült létrehozni. Gyõzõdj meg arról, hogy írható-e a modules/mod_swmenupro/styles mappa.' );
...
define( '_SW_MODULE_FAIL', 'A modult nem sikerült frissíteni. Gyõzõdj meg arról, hogy írható-e a /modules mappa.' );
...
define( '_SW_COMPONENT_FAIL', 'A frissítés nem sikerült, gyõzõdj meg arról, hogy írhatóak-e az alábbi listában szereplõ mappák.' );
...
define( '_SW_AUTO_CSS_CREATOR_LABEL', 'Automatikus CSS-készítõ' );
...
define( '_SW_BORDER_TOP_SELECT', 'Felsõ szegély' );
...
define( '_SW_AUTO_TOP_SELECT', 'Fõmenüpontok' );
...
define( '_SW_TEXT_TRANSFORM', 'Betûváltozat' );
define( '_SW_TEXT_INDENT', 'Behúzás' );
define( '_SW_WHITE_SPACE', 'Helyköz' );
define( '_SW_FONT_STYLE', 'Betûstílus' );
...
define( '_SW_FONT_TIP', 'Minden böngészõ eltérõ módon jeleníti meg az egyes betûket, ill. betûméreteket. Az alábbi lista megmutatja, hogy a Te böngészõd hogyan jeleníti meg a különbözõ betûket és betûméreteket.' );
...
define( '_SW_FONT', 'betûszíne' );
define( '_SW_OVER_FONT', 'egérráviteli betûszíne' );
...
define( '_SW_SUB_INDICATOR', 'Almenüjelzõ ikon' );
...
//tool tips
define( '_SW_MENU_SOURCE_TIP', 'Válaszd ki azt az érvényes/létezõ menüt, amely forrásként szolgál a menümodulod számára.' );
define( '_SW_PARENT_TIP', 'Válaszd ki azt a szülõ elemet, amely megjeleníti a forrásmenü egy részét. Ha mindegyik menüpontot meg akarod jeleníteni, akkor a szülõ elemet állítsd TOP-ra .' );
define( '_SW_STYLE_SHEET_TIP', '<b>Dinamikus: </b>közvetlenül abba a lapba kerülnek a stílusinformációk, amely a modult megjeleníti.<br /><b>Külsõ hivatkozás: </b>egy, már kimentett külsõ stíluslapra hivatkozik.<br /><b>Nincs hivatkozás:</b> Sajátkezûleg illeszd be a külsõ stíluslapra mutató hivatkozást, a sablonod fejléc részében. A menümodulod így lesz teljesen mûködõképes.' );
...
define( '_SW_MAX_LEVELS_TIP', 'A megjelenítendõ forrásmenü szintjeinek száma. Az összes szint megjelenítéséhez állítsd 0-ra.' );
