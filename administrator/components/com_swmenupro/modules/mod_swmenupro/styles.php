...
function click_customcss($ordered,$item,$id,$class){
	...
	if($item['indent']==0){
		if($class){
			$str.="#click-menu".$id."-".($item['ORDER']-1).$class." {\n";
		}else{
...
function clickslide_customcss($ordered,$item,$id,$class){
	...
	if($item['indent']==0){
		if($class){
			$str.="#topclick".$id.($item['ORDER'])." a.inbox1:hover, #topclick".$id.($item['ORDER'])." a.inbox1-active {\n";
		}else{
			$str.=" #topclick".$id.($item['ORDER'])." a.inbox1{\n";
		}
	}else{
