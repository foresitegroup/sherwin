...
if (file_exists($mosConfig_absolute_path.'/administrator/components/com_swmenupro/language/'.$mosConfig_lang.'.php'))
{
	//include($mosConfig_absolute_path.'/administrator/components/com_swmenupro/language/'.$mosConfig_lang.'.php');
}
else
{
...
function swGetMenuLinks2($menu,$id,$hybrid,$use_tables){
	...
	if ($menu=="swcontentmenu") {
		...
		for($i=0;$i<count($result);$i++) {
			...
			$url="index.php?option=com_virtuemart&page=shop.browse&category_id=" . $result2->category_id ;
	...
	$com_entries=$database->loadResult();
  	...
  	if(file_exists($mosConfig_absolute_path . '/modules/mod_swmenupro.xml')){
  		...
  		if($row->module_version<$row->new_module_version){
  			if(copydirr($mosConfig_absolute_path."/administrator/components/com_swmenupro/modules",$mosConfig_absolute_path."/modules",0757,false)){
...
function uploadPackage(  ) {
	...
	if($upload_version=="swmenupro_language_file"){
		if(copydirr($msg,$mosConfig_absolute_path . '/administrator/components/com_swmenupro/language',0757,false)){
		...
		if(copydirr($msg,$mosConfig_absolute_path . '/administrator/components/com_swmenupro',0757,false)){
