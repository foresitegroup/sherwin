...
require_once( $mosConfig_absolute_path.'/administrator/components/com_jcalpro/installer/themes/themes.html.php' );
...
function showInstalledThemes( $_option ) {
	...
	$mambotBaseDir	= mosPathName( mosPathName( $mosConfig_absolute_path ) . "components/com_jcalpro/themes" );
    $xmlfile = '';
	$id = 0;
	$n = count( $rows );
	for ($i = 0; $i < $n; $i++) {
