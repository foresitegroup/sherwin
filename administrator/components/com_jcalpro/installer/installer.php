...
require_once( $mosConfig_absolute_path . "/administrator/components/com_jcalpro/installer/installer.html.php" );
require_once( $mosConfig_absolute_path . "/administrator/components/com_jcalpro/installer/installer.class.php" );
...
function extcalInstaller( $option, $client, $opt )
{
    ...
    $path = $mosConfig_absolute_path . "/administrator/components/com_jcalpro/installer/$element/$element.php";
    ...
    if (array_key_exists ( $element, $classMap )) {
    	require_once( $mosConfig_absolute_path . "/administrator/components/com_jcalpro/installer/$element/$element.class.php" );
