...
{
    global $mainframe, $CONFIG_EXT, $database, $lang_settings_data, $lang_info, $lang_date_format;
...
EOT;
    $lang_setting = $mainframe->getCfg('lang');
...
{
    global $CONFIG_EXT, $database, $acl;
