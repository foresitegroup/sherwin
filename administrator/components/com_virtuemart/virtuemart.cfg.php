...
define( 'SECUREURL', 'http://www.sherwinindustriesinc.com/sherwin/' );
...
define('DOWNLOADROOT', '/home/content/s/h/e/sherwinind/html/sherwin/');
define('_SHOW_PRICES', '');
define('ORDER_MAIL_HTML', '1');
define('HOMEPAGE', 'shop.index');
define('FLYPAGE', 'flypage');
define('CATEGORY_TEMPLATE', 'browse_8');
...
$VM_BROWSE_ORDERBY_FIELDS = array( 'product_name','product_sku' );
