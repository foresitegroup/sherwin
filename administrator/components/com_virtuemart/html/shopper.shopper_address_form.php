...
/**
*
* @version $Id: shopper.shopper_address_form.php 617 2007-01-04 19:43:08Z soeren_nb $
* @package VirtueMart
* @subpackage html
...
<h2><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ADDRESS_INFO_LBL ?></H2>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="2" >
    <tr>
      <td colspan="2" nowrap align="right" >
        <div align="left"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_SHIPTO_LBL ?></b></div>
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ADDRESS_LABEL ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="address_type_name" value="<?php $db->sp("address_type_name") ?>" size="18" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_FIRST_NAME ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="first_name" size="18" value="<?php $db->sp("first_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_LAST_NAME ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="last_name" size="18" value="<?php $db->sp("last_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_MIDDLE_NAME ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="middle_name" size="16" value="<?php $db->sp("middle_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_TITLE ?>:</td>
      <td width="79%" > <?php $ps_html->list_user_title($db->sf("title")); ?></td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_COMPANY_NAME ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="company" size="24" value="<?php $db->sp("company") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ADDRESS_1 ?>: </td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="address_1" size="24" value="<?php $db->sp("address_1") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ADDRESS_2 ?>: 
      </td>
      <td width="79%" > 
    ...
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_CITY ?>:</td>
      <td width="79%" > 
    ...
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_STATE ?>:</td>
      <td width="79%" > 
    ...
    <?php } ?>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ZIP ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="zip" size="10" value="<?php $db->sp("zip") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_COUNTRY ?>:</td>
      <td width="79%" > 
        <?php $ps_html->list_country("country",$db->sf("country")) ?>
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" > <?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_PHONE ?>:</td>
      <td width="79%" > 
        <input type="text" class="inputbox" name="phone_1" size="12" value="<?php $db->sp("phone_1") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="21%" nowrap align="right" ><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_FAX ?>:</td>
      <td width="79%" > 
