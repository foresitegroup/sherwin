...
*
* @version $Id: ro_basket_b2c.html.php 617 2007-01-04 19:43:08Z soeren_nb $
* @package VirtueMart
...
<?php if ( $tax ) { ?>
  <tr class="sectiontableentry2">
	<td colspan="4" class="theTax" align="right" valign="top"><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_TOTAL_TAX ?>: </td> 
	<td class="theTax"><?php echo $tax_display ?> </td>
  </tr>
<?php } 
?>
  <tr>
