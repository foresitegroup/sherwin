...
*
* @version $Id: shop.browse.php 743 2007-03-02 10:08:37Z soeren_nb $
* @package VirtueMart
* @subpackage html
...
echo"<div id='bigCharlesDiv'>";
echo "<h3 id='productTitle'>Products</h3><div id='pdfText'></div>";  //.$VM_LANG->_PHPSHOP_BROWSE_LBL."</h3>\n";
...
<?php 
	...
	if( $use_tables ) {
		...
		echo '<div class="product_list" style="width:100%; float:none;"><div id="charlesHead">the products</div>';
	}
